import { b as getImage } from '../chunks/_astro_assets_CbAMe3DI.mjs';
import { i as icon } from '../chunks/icon_CzHbM_ST.mjs';
...
const maskableIcon = new Proxy({"src":"/_astro/icon-maskable.C1A7b-dw.png","width":1024,"height":1024,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/data/work/web/mycompanysite/src/images/icon-maskable.png";
							}
